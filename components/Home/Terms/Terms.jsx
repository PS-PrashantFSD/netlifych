    ...
    <ContentSection>
      <AnimateOnScreen>
        <Wrap>
          ...
          <Paragraph>
            Our Privacy Policy sets out how we collect, use, and protect your information when you use our website. 
            We are committed to safeguarding your privacy and ensuring that your personal information is handled 
            responsibly.
          </Paragraph>
          <Paragraph>
            We may collect personal information from you when you use our website, including but not limited to 
            your name, email address, and other contact details. This information will only be used for the purposes 
